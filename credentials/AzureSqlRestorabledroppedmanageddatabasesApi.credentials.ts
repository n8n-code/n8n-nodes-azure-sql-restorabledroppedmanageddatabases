...
export class AzureSqlRestorabledroppedmanageddatabasesApi implements ICredentialType {
	name = 'N8nDevAzureSqlRestorabledroppedmanageddatabasesApi';

	displayName = 'Azure SQL Restorabledroppedmanageddatabases API';

	icon: Icon = { light: 'file:../nodes/AzureSqlRestorabledroppedmanageddatabases/azure-sql-restorabledroppedmanageddatabases.png', dark: 'file:../nodes/AzureSqlRestorabledroppedmanageddatabases/azure-sql-restorabledroppedmanageddatabases.dark.png' };
	...
	properties: INodeProperties[] = [
		{
			...
			description: 'The base URL of your Azure SQL Restorabledroppedmanageddatabases API server',
		},
		{
			displayName: 'API Key',
			name: 'apiKey',
